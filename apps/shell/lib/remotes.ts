...
export const REMOTE_APPS: Record<RemoteAppId, RemoteAppDefinition> = {
  products: {
    ...
    framework: 'Next.js',
    shellPath: '/products',
    standaloneOrigin: getRemoteOrigin('NEXT_PUBLIC_PRODUCTS_REMOTE_ORIGIN', 'http://localhost:3001'),
  ...
  cart: {
    ...
    framework: 'Next.js',
    shellPath: '/cart',
    standaloneOrigin: getRemoteOrigin('NEXT_PUBLIC_CART_REMOTE_ORIGIN', 'http://localhost:3002'),
  ...
  profile: {
    ...
    framework: 'Nuxt 3',
    shellPath: '/profile',
    standaloneOrigin: getRemoteOrigin('NEXT_PUBLIC_PROFILE_REMOTE_ORIGIN', 'http://localhost:3003'),
